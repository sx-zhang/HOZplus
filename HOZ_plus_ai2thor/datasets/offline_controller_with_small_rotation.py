...
class OfflineControllerWithSmallRotation(BaseController):  
    ...
    def __init__(
            ...
            grid_size=0.25,
            fov=100,
            offline_data_dir='/data_sdd/datadrh/HOZ/data/Scene_Data',
            detection_feature_file_name='detr_feature_22cls.hdf5',
        ...
        self.detection_feature_hoz = None # yxy added
    ...
    def reset(self, scene_name=None):             
        ...
        if scene_name != self.scene_name:
            ...
            self.detection_feature_hoz = self.h5py.File(
                os.path.join(
                    self.offline_data_dir, self.scene_name, "det_feature_22_cates.hdf5"
                ),
                'r',
            )
    ...
    def get_detection_feature(self):
        return self.detection_feature[str(self.state)][()],self.detection_feature_hoz[str(self.state)][()]
