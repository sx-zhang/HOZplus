...
scenes = [f"FloorPlan_Train{i}_1" for i in range(1, 13)] + [f"FloorPlan_Train{i}_2" for i in range(1, 13)] + [f"FloorPlan_Train{i}_3" for i in range(1, 13)] + [f"FloorPlan_Train{i}_4" for i in range(1, 13)] + [f"FloorPlan_Train{i}_5" for i in range(1, 13)] 
...
with bz2.BZ2File("./saved_graphs/{}_graph.pbz2".format(scenes[0]), "rb") as fp:
    graph_1 = cPickle.load(fp)
    
for i in range(1, len(scenes)):
    with bz2.BZ2File("./saved_graphs/{}_graph.pbz2".format(scenes[i]), "rb") as fp:
...
with bz2.BZ2File("./saved_graphs/merged_ai2thor_hoz_graph.pbz2", "w") as fp:
    cPickle.dump(
        {
            "nodes": graph_1['nodes'],
            "edges": graph_1['edges']
