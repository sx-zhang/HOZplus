...
def parse_arguments():
    ...
    parser.add_argument(
        '--save-model-dir',
        default='/mmu-vcg/zhangsixian/DAT/trained_models/',
        metavar='SMD',
    ...
    parser.add_argument(
        '--log-dir',
        default='/mmu-vcg/zhangsixian/ICLR_VTNet/work_dirs/runs/',
        metavar='LG',
    ...
    parser.add_argument(
        '--data-dir',
        type=str,
        default='/mmu-vcg/zhangsixian/data/AI2Thor_offline_data/',
